...
progs=(
    ...
    # ['cg_mkl_ie_d']="${script_dir}/src/cg_mkl_ie_d.exe"
    # ['cg_mkl_ie_f']="${script_dir}/src/cg_mkl_ie_f.exe"
    # ['cg_div_d']="${script_dir}/src/cg_div_d.exe"
    ...
    # ['csr_d']="${script_dir}/src/spmv_csr_d.exe" # BENCH_AMD, BENCH_INTEL
    # ['csr_f']="${script_dir}/src/spmv_csr_f.exe"
    # ['csr_sym_d']="${script_dir}/src/spmv_csr_sym_d.exe" # BENCH_SYM
    # ['csr_sym_f']="${script_dir}/src/spmv_csr_sym_f.exe" # BENCH_SYM
    # ['csr_kahan_d']="${script_dir}/src/spmv_csr_kahan_d.exe"
    # ['csr_prefetch_d']="${script_dir}/src/spmv_csr_prefetch_d.exe"
    # ['csr_simd_d']="${script_dir}/src/spmv_csr_simd_d.exe"
    # ['csr_vector_d']="${script_dir}/src/spmv_csr_vector_d.exe"
    ...
    # ['csr_cv_block_id_d']="${script_dir}/src/spmv_csr_cv_block_id_d.exe" # BENCH_AMD
    # ['csr_cv_block_d2f_d']="${script_dir}/src/spmv_csr_cv_block_d2f_d.exe" # BENCH_AMD
    # ['csr_cv_block_fpc_d']="${script_dir}/src/spmv_csr_cv_block_fpc_d.exe" # BENCH_AMD
    # ['csr_cv_block_zfp_d']="${script_dir}/src/spmv_csr_cv_block_zfp_d.exe" # BENCH_AMD
    # ['csr_cv_block_fpzip_d']="${script_dir}/src/spmv_csr_cv_block_fpzip_d.exe" # BENCH_AMD
    ...
    # ['div_rf_const_size_row_d']="${script_dir}/src/spmv_div_rf_const_size_row_d.exe"
    ...
    # ['mkl_ie_f']="${script_dir}/src/spmv_mkl_ie_f.exe" # BENCH_AMD, BENCH_INTEL
    ...
    # CSR5
    # ['csr5_d']="${script_dir}/src/spmv_csr5_d.exe" # BENCH_AMD, BENCH_INTEL

    # merge spmv
    # ['merge_d']="${script_dir}/src/spmv_merge_d.exe" # BENCH_AMD, BENCH_INTEL
    ...
    # ['sparsex_f']="${script_dir}/src/spmv_sparsex_f.exe" # This crashes!

    # SpV8
    # ['spv8_d']="${script_dir}/src/spmv_spv8_d.exe"

    # LCM - partially strided codelet
    # ['lcm_d']="${script_dir}/src/LCM-partially-strided-codelet/spmv_lcm_d.exe" # BENCH_AMD, BENCH_INTEL

    # CFS
    # ['cfs_d']="${script_dir}/src/cfs-spmv/build/bench/spmv_cfs_d.exe" # BENCH_SYM
    # ['cfs_f']="${script_dir}/src/cfs-spmv/build/bench/spmv_cfs_f.exe" # BENCH_SYM
    ...
    # ['csr_cuda_adaptive_b1024_mb2_nv_d']="${script_dir}/src/spmv_csr_cuda_adaptive_b1024_mb2_nv_d.exe"
    # ['csr_cuda_adaptive_b256_mb1_nv_d']="${script_dir}/src/spmv_csr_cuda_adaptive_b256_mb1_nv_d.exe"
    # ['csr_cuda_adaptive_v3_s4_c16_b256_mb4_nv_d']="${script_dir}/src/spmv_csr_cuda_adaptive_v3_s4_c16_b256_mb4_nv_d.exe"
    # ['csr_cuda_adaptive_s16_b256_mb2_nv_d']="${script_dir}/src/spmv_csr_cuda_adaptive_s16_b256_mb2_nv_d.exe"

    # Research GPU formats
    # CSR5
    # ['csr5_cuda_nv_d']="${script_dir}/src/spmv_csr5_cuda_nv_d.exe"

    # Merge    
    # ['merge_cuda_nv_d']="${script_dir}/src/spmv_merge_cuda_nv_d.exe"

    # DASP
    # ['dasp_cuda_nv_d']="${script_dir}/src/spmv_dasp_cuda_nv_d.exe"

    # cusparse
    # ['cusparse_csr_nv_d']="${script_dir}/src/spmv_cusparse_csr_nv_d.exe"
    # ['cusparse_csr_s4_nv_d']="${script_dir}/src/spmv_cusparse_csr_s4_nv_d.exe"
    # ['cusparse_coo_nv_d']="${script_dir}/src/spmv_cusparse_coo_nv_d.exe"
    # ['cusparse_coo_s4_nv_d']="${script_dir}/src/spmv_cusparse_coo_s4_nv_d.exe"
    # ['cusparse_csc_nv_d']="${script_dir}/src/spmv_cusparse_csc_nv_d.exe"
    # ['cusparse_csc_s4_nv_d']="${script_dir}/src/spmv_cusparse_csc_s4_nv_d.exe"

    # ROCM
    # rocm vector
    # ['csr_rocm_vector_b256_nv_d']="${script_dir}/src/spmv_csr_rocm_vector_b256_nv_d.exe"
    # ['csr_rocm_vector_b512_nv_d']="${script_dir}/src/spmv_csr_rocm_vector_b512_nv_d.exe"
    # ['csr_rocm_vector_b1024_nv_d']="${script_dir}/src/spmv_csr_rocm_vector_b1024_nv_d.exe"

    # rocm adaptive
    # ['csr_rocm_adaptive_b256_mb1_nv_d']="${script_dir}/src/spmv_csr_rocm_adaptive_b256_mb1_nv_d.exe"
    # ['csr_rocm_adaptive_b512_mb1_nv_d']="${script_dir}/src/spmv_csr_rocm_adaptive_b512_mb1_nv_d.exe"
    # ['csr_rocm_adaptive_b1024_mb1_nv_d']="${script_dir}/src/spmv_csr_rocm_adaptive_b1024_mb1_nv_d.exe"

    # Custom rocm (dgal implementation)
    # ['csr_rocm_const_nnz_per_thread_b512_nnz4_nv_d']="${script_dir}/src/spmv_csr_rocm_const_nnz_per_thread_b512_nnz4_nv_d.exe"
    # ['csr_rocm_const_nnz_per_thread_b1024_nnz4_nv_d']="${script_dir}/src/spmv_csr_rocm_const_nnz_per_thread_b1024_nnz4_nv_d.exe"

    # ['csr_rocm_acc_flat_b512_nv_d']="${script_dir}/src/spmv_csr_rocm_acc_flat_b512_nv_d.exe"
    # ['csr_rocm_acc_line_enhance_b512_nv_d']="${script_dir}/src/spmv_csr_rocm_acc_line_enhance_b512_nv_d.exe"

    # rocsparse
    # ['rocparse_csr_nv_d']="${script_dir}/src/spmv_rocsparse_csr_nv_d.exe"
    # ['rocparse_coo_nv_d']="${script_dir}/src/spmv_rocsparse_coo_nv_d.exe"
    # ['rocparse_hyb_nv_d']="${script_dir}/src/spmv_rocsparse_hyb_nv_d.exe"
