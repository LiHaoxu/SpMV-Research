...
init_thread_statistics(struct thread_data * td)
{
	...
	#include "div_kernels_adapt.h"
#elif defined(DIV_TYPE_RF_CONST_SIZE_ROW)
	#include "div_kernels_rf_const_size_row.h"
	...
	#include "div_sym_kernels_rf_local_split_new_packet.h"
	// #include "div_sym_kernels_rf_local_split_new_packet_accum.h"
#else
	#include "div_kernels.h"
#endif
