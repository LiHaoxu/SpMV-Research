...
static inline
long
compress_kernel_sort_diff(INT_T * row_ptr, INT_T * ja, ValueTypeReference * vals, long i_s, __attribute__((unused)) long i_t_s, __attribute__((unused)) long i_t_e, long j_s, unsigned char * buf, long num_vals, long * num_vals_out)
{
	int tnum = omp_get_thread_num();
	struct thread_data * td = tds[tnum];
