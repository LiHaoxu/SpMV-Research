...
static inline
long
compress_kernel(INT_T * row_ptr, INT_T * ja, ValueType * vals, long i_s, long j_s, unsigned char * buf, long num_vals, long * num_vals_out)
{
	...
	data_intro[data_intro_bytes] = type;
	data_intro_bytes += 1;
...
static inline
long
compress_kernel_rf(INT_T * row_ptr, INT_T * ja, ValueType * vals, long i_s, long j_s, unsigned char * buf, long num_vals, long * num_vals_out)
{
	...
	if (((double) num_vals_unique) / ((double) num_vals) > 0.75)
		return -1;
...
{
	long ret;
	ret = compress_kernel_rf(row_ptr, ja, vals, i_s, j_s, buf, num_vals, num_vals_out);
	if (ret < 0)
		ret = compress_kernel(row_ptr, ja, vals, i_s, j_s, buf, num_vals, num_vals_out);
	return ret;
}
...
static __attribute__((always_inline)) inline
long
decompress_and_compute_kernel(unsigned char * restrict buf, ValueType * restrict x, ValueType * restrict y, long * restrict num_vals_out, const int validate,
		...
		)
{
	...
	type = data_intro[data_intro_bytes];
	data_intro_bytes += 1;
...
static __attribute__((always_inline)) inline
long
decompress_and_compute_kernel_rf(unsigned char * restrict buf, ValueType * restrict x, ValueType * restrict y, long * restrict num_vals_out, const int validate,
		void (* gather_coords)(long i, unsigned char * data_coords, const uint64_t coords_bytes, uint64_t row_bits, uint64_t col_bits, uint64_t * row_rel_out, uint64_t * col_rel_out),
		void (* gather_coords_v)(long i, unsigned char * data_coords, const uint64_t coords_bytes, uint64_t row_bits, uint64_t col_bits, vec_i_t * row_rel_out, vec_i_t * col_rel_out)
		)
{
...
decompress_and_compute_kernel_sort_diff_base(typeof(decompress_and_compute_kernel) * decompress_fun, unsigned char * restrict buf, ValueType * restrict x, ValueType * restrict y, long * restrict num_vals_out, const int validate)
{
	...
	if (__builtin_expect(row_bits == 8, 1))
	{
		switch (col_bits) {
			case 8:
				return decompress_fun(buf, x, y, num_vals_out, validate, gather_coords_sparse_r1_c1, gather_coords_sparse_r1_c1_v);
			case 16:
				return decompress_fun(buf, x, y, num_vals_out, validate, gather_coords_sparse_r1_c2, gather_coords_sparse_r1_c2_v);
			case 24:
				return decompress_fun(buf, x, y, num_vals_out, validate, gather_coords_sparse_r1_c3, gather_coords_sparse_r1_c3_v);
			case 32:
				return decompress_fun(buf, x, y, num_vals_out, validate, gather_coords_sparse_r1_c4, gather_coords_sparse_r1_c4_v);
		}
	}
	...
	if (row_bits == 0)
	{
		// return decompress_fun(buf, x, y, num_vals_out, validate, gather_coords_sparse_r0, gather_coords_sparse_r0_v, 0);
		switch (col_bits) {
			case 8:
				return decompress_fun(buf, x, y, num_vals_out, validate, gather_coords_sparse_r0_c1, gather_coords_sparse_r0_c1_v);
			case 16:
				return decompress_fun(buf, x, y, num_vals_out, validate, gather_coords_sparse_r0_c2, gather_coords_sparse_r0_c2_v);
			case 24:
				return decompress_fun(buf, x, y, num_vals_out, validate, gather_coords_sparse_r0_c3, gather_coords_sparse_r0_c3_v);
			case 32:
				return decompress_fun(buf, x, y, num_vals_out, validate, gather_coords_sparse_r0_c4, gather_coords_sparse_r0_c4_v);
		}
	}

	switch (coords_bytes) {
		case 1:
			return decompress_fun(buf, x, y, num_vals_out, validate, gather_coords_dense_1, gather_coords_dense_1_v);
		case 2:
			return decompress_fun(buf, x, y, num_vals_out, validate, gather_coords_dense_2, gather_coords_dense_2_v);
		case 3:
			return decompress_fun(buf, x, y, num_vals_out, validate, gather_coords_dense_3, gather_coords_dense_3_v);
		case 4:
			return decompress_fun(buf, x, y, num_vals_out, validate, gather_coords_dense_4, gather_coords_dense_4_v);
	}

	return decompress_fun(buf, x, y, num_vals_out, validate, gather_coords_dense, gather_coords_dense_v);
...
decompress_and_compute_kernel_sort_diff_select(unsigned char * restrict buf, ValueType * restrict x, ValueType * restrict y, long * restrict num_vals_out, const int validate)
{
	...
	if (type == 1)
		return decompress_and_compute_kernel_sort_diff_base(decompress_and_compute_kernel_rf, buf, x, y, num_vals_out, validate);
	else
		return decompress_and_compute_kernel_sort_diff_base(decompress_and_compute_kernel, buf, x, y, num_vals_out, validate);
}
