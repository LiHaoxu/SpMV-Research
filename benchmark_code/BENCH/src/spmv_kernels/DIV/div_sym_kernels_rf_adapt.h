...
compress_init_sort_diff(__attribute__((unused)) ValueType * vals, __attribute__((unused)) const long num_vals, long packet_size)
{
	...
	malloc_thread_local_2D(t_window, 2*window_size);
	malloc_thread_local_2D(t_window_buf, window_size);
	malloc_thread_local_2D(t_window_ia, 2*window_size);
	malloc_thread_local_2D(t_window_ja, 2*window_size);
	...
	malloc_thread_local_2D(t_window_sym, window_size);
	malloc_thread_local_2D(t_rows_sym, window_size);
	malloc_thread_local_2D(t_cols_sym, window_size);
...
compress_kernel_sort_diff(INT_T * row_ptr, INT_T * ja, ValueType * vals, long i_s, long i_t_s, long i_t_e, long j_s, unsigned char * buf, long num_vals_suggested, long * num_vals_out)
{
	...
	ValueType * window_sym = t_window_sym[tnum];
	...
	num_vals = k;
	// printf("compress_kernel_sort_diff: num_vals=%ld, num_vals_sym=%ld\n", num_vals, num_vals_sym);
	...
	if (num_vals_sym > 0)
	{
		packet_bytes_sym = compress_kernel_sort_diff_base(&data[data_bytes],
			num_vals_sym,
			window_sym,
			rows_sym,
			cols_sym,
	...
	*data_intro_packet_sym_bytes_ptr = packet_bytes_sym;
		...
		)
{
	...
	// if (row_bits == 8)
	{
		switch (col_bits) {
			case 8:
				return decompress_and_compute_kernel_sort_diff_base(buf, x, y, num_vals_out, validate, gather_coords_sparse_r1_c1, gather_coords_sparse_r1_c1_v, mult_add, mult_add_v);
			case 16:
				return decompress_and_compute_kernel_sort_diff_base(buf, x, y, num_vals_out, validate, gather_coords_sparse_r1_c2, gather_coords_sparse_r1_c2_v, mult_add, mult_add_v);
			case 24:
				return decompress_and_compute_kernel_sort_diff_base(buf, x, y, num_vals_out, validate, gather_coords_sparse_r1_c3, gather_coords_sparse_r1_c3_v, mult_add, mult_add_v);
			case 32:
				return decompress_and_compute_kernel_sort_diff_base(buf, x, y, num_vals_out, validate, gather_coords_sparse_r1_c4, gather_coords_sparse_r1_c4_v, mult_add, mult_add_v);
		}
	}
	...
	if (row_bits == 0)
	{
		// return decompress_and_compute_kernel_sort_diff_base(buf, x, y, num_vals_out, validate, gather_coords_sparse_r0, gather_coords_sparse_r0_v, mult_add, mult_add_v);
		switch (col_bits) {
			case 8:
				return decompress_and_compute_kernel_sort_diff_base(buf, x, y, num_vals_out, validate, gather_coords_sparse_r0_c1, gather_coords_sparse_r0_c1_v, mult_add, mult_add_v);
			case 16:
				return decompress_and_compute_kernel_sort_diff_base(buf, x, y, num_vals_out, validate, gather_coords_sparse_r0_c2, gather_coords_sparse_r0_c2_v, mult_add, mult_add_v);
			case 24:
				return decompress_and_compute_kernel_sort_diff_base(buf, x, y, num_vals_out, validate, gather_coords_sparse_r0_c3, gather_coords_sparse_r0_c3_v, mult_add, mult_add_v);
			case 32:
				return decompress_and_compute_kernel_sort_diff_base(buf, x, y, num_vals_out, validate, gather_coords_sparse_r0_c4, gather_coords_sparse_r0_c4_v, mult_add, mult_add_v);
		}
	}

	switch (coords_bytes) {
		case 1:
			return decompress_and_compute_kernel_sort_diff_base(buf, x, y, num_vals_out, validate, gather_coords_dense_1, gather_coords_dense_1_v, mult_add, mult_add_v);
		case 2:
			return decompress_and_compute_kernel_sort_diff_base(buf, x, y, num_vals_out, validate, gather_coords_dense_2, gather_coords_dense_2_v, mult_add, mult_add_v);
		case 3:
			return decompress_and_compute_kernel_sort_diff_base(buf, x, y, num_vals_out, validate, gather_coords_dense_3, gather_coords_dense_3_v, mult_add, mult_add_v);
		case 4:
			return decompress_and_compute_kernel_sort_diff_base(buf, x, y, num_vals_out, validate, gather_coords_dense_4, gather_coords_dense_4_v, mult_add, mult_add_v);
	}

	return decompress_and_compute_kernel_sort_diff_base(buf, x, y, num_vals_out, validate, gather_coords_dense, gather_coords_dense_v, mult_add, mult_add_v);
...
decompress_and_compute_kernel_sort_diff(unsigned char * restrict buf, ValueType * restrict x, ValueType * restrict y, __attribute__((unused)) long i_t_s, __attribute__((unused)) long i_t_e)
{
	...
	{
		packet_bytes = decompress_and_compute_kernel_sort_diff_select(data, x, y, NULL, 0, mult_add_serial, mult_add_vector);
	}
	data += packet_bytes;

	if (data_intro_packet_sym_bytes > 0)
	{
		packet_bytes_sym = decompress_and_compute_kernel_sort_diff_select(data, x, y, NULL, 0, mult_add_serial_sym, mult_add_vector_sym);
	}
...
decompress_kernel_sort_diff(INT_T * ia_out, INT_T * ja_out, ValueType * a_out, long * num_vals_out, unsigned char * restrict buf, __attribute__((unused)) long i_t_s, __attribute__((unused)) long i_t_e)
{
	...
	if (data_intro_packet_bytes > 0)
	{
		packet_bytes = decompress_and_compute_kernel_sort_diff_select(data, NULL, NULL, &num_vals, 1, mult_add_serial, mult_add_vector);
		for (i=0;i<num_vals;i++)
		{
			a_out[i] = window[i];
	...
	if (data_intro_packet_sym_bytes > 0)
	{
		packet_bytes_sym = decompress_and_compute_kernel_sort_diff_select(data, NULL, NULL, &num_vals_sym, 1, mult_add_serial_sym, mult_add_vector_sym);
