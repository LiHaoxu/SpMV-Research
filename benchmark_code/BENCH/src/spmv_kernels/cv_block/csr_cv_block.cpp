...
extern "C"{
	...
	#include "csr_cv_block_compression_kernels_id.h"
#elif defined(COMPRESSION_KERNEL_D2F)
	#include "csr_cv_block_compression_kernels_d2f.h"
#elif defined(COMPRESSION_KERNEL_FPC)
	#include "csr_cv_block_compression_kernels_fpc.h"
#elif defined(COMPRESSION_KERNEL_ZFP)
	#include "csr_cv_block_compression_kernels_zfp.h"
#elif defined(COMPRESSION_KERNEL_FPZIP)
	#include "csr_cv_block_compression_kernels_fpzip.h"
#endif
