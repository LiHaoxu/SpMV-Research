...
#define vec_set_iter_f32_32(iter, expr)                    ({ vec_f32_16_t _buf; vec_loop_stmt(32, iter, ((vec_alias_float32_t *) &_buf)[iter] = (expr););  _buf; })
#define vec_set_iter_f32_16(iter, expr)                    ({ vec_f32_8_t  _buf; vec_loop_stmt(16, iter, ((vec_alias_float32_t *) &_buf)[iter] = (expr););  _buf; })
#define vec_set_iter_f32_8(iter, expr)                     ({ vec_f32_4_t  _buf; vec_loop_stmt( 8, iter, ((vec_alias_float32_t *) &_buf)[iter] = (expr););  _buf; })
#define vec_set_iter_f32_4(iter, expr)                     ({ vec_f32_2_t  _buf; vec_loop_stmt( 4, iter, ((vec_alias_float32_t *) &_buf)[iter] = (expr););  _buf; })
...
#define vec_maskz_loadu_f32_32(ptr, mask)                  ( __riscv_vmerge_vvm_f32m1(__riscv_vfmv_v_f_f32m1(0, 32), __riscv_vle32_v_f32m1_m(mask, (vec_alias_float32_t *) (ptr), 32), mask, 32) )
#define vec_maskz_loadu_f32_16(ptr, mask)                  ( __riscv_vmerge_vvm_f32m1(__riscv_vfmv_v_f_f32m1(0, 16), __riscv_vle32_v_f32m1_m(mask, (vec_alias_float32_t *) (ptr), 16), mask, 16) )
#define vec_maskz_loadu_f32_8(ptr, mask)                   ( __riscv_vmerge_vvm_f32m1(__riscv_vfmv_v_f_f32m1(0,  8), __riscv_vle32_v_f32m1_m(mask, (vec_alias_float32_t *) (ptr),  8), mask,  8) )
#define vec_maskz_loadu_f32_4(ptr, mask)                   ( __riscv_vmerge_vvm_f32m1(__riscv_vfmv_v_f_f32m1(0,  4), __riscv_vle32_v_f32m1_m(mask, (vec_alias_float32_t *) (ptr),  4), mask,  4) )
#define vec_maskz_loadu_f32_1(ptr, mask)                   ( (mask) ? (*((vec_alias_float32_t *) (ptr))) : 0 )
...
#define vec_mask_storeu_f32_32(ptr, vec, mask)             __riscv_vse32_v_f32m1_m(mask, (vec_alias_float32_t *) (ptr), vec, 32)
#define vec_mask_storeu_f32_16(ptr, vec, mask)             __riscv_vse32_v_f32m1_m(mask, (vec_alias_float32_t *) (ptr), vec, 16)
#define vec_mask_storeu_f32_8(ptr, vec, mask)              __riscv_vse32_v_f32m1_m(mask, (vec_alias_float32_t *) (ptr), vec,  8)
#define vec_mask_storeu_f32_4(ptr, vec, mask)              __riscv_vse32_v_f32m1_m(mask, (vec_alias_float32_t *) (ptr), vec,  4)
#define vec_mask_storeu_f32_1(ptr, vec, mask)              do { if (mask) (*((vec_alias_float32_t *) (ptr))) = (vec); } while (0)

#define vec_gather_f32_i32_16(ptr, idx)                    __riscv_vluxei32_v_f32m1((vec_alias_float32_t *) (ptr), __riscv_vsll_vx_u32m1(idx, 2, 32), 32)
#define vec_gather_f32_i32_8(ptr, idx)                     __riscv_vluxei32_v_f32m1((vec_alias_float32_t *) (ptr), __riscv_vsll_vx_u32m1(idx, 2, 16), 16)
#define vec_gather_f32_i32_4(ptr, idx)                     __riscv_vluxei32_v_f32m1((vec_alias_float32_t *) (ptr), __riscv_vsll_vx_u32m1(idx, 2,  8),  8)
#define vec_gather_f32_i32_2(ptr, idx)                     __riscv_vluxei32_v_f32m1((vec_alias_float32_t *) (ptr), __riscv_vsll_vx_u32m1(idx, 2,  4),  4)
#define vec_gather_f32_i32_1(ptr, idx)                     ( ((vec_alias_float32_t *) (ptr))[idx] )

#define vec_gather_f32_i64_16(ptr, idx)                    __riscv_vluxei64_v_f32m1((vec_alias_float32_t *) (ptr), __riscv_vsll_vx_u64m1(idx, 2, 32), 32)
#define vec_gather_f32_i64_8(ptr, idx)                     __riscv_vluxei64_v_f32m1((vec_alias_float32_t *) (ptr), __riscv_vsll_vx_u64m1(idx, 2, 16), 16)
#define vec_gather_f32_i64_4(ptr, idx)                     __riscv_vluxei64_v_f32m1((vec_alias_float32_t *) (ptr), __riscv_vsll_vx_u64m1(idx, 2,  8),  8)
#define vec_gather_f32_i64_2(ptr, idx)                     __riscv_vluxei64_v_f32m1((vec_alias_float32_t *) (ptr), __riscv_vsll_vx_u64m1(idx, 2,  4),  4)
#define vec_gather_f32_i32_1(ptr, idx)                     ( ((vec_alias_float32_t *) (ptr))[idx] )
