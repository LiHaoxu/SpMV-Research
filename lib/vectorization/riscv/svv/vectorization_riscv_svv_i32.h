...
#define vec_set_iter_i32_32(iter, expr)                    ({ vec_i32_16_t _buf; vec_loop_stmt(32, iter, ((vec_alias_int32_t *) &_buf)[iter] = (expr););  _buf; })
#define vec_set_iter_i32_16(iter, expr)                    ({ vec_i32_8_t  _buf; vec_loop_stmt(16, iter, ((vec_alias_int32_t *) &_buf)[iter] = (expr););  _buf; })
#define vec_set_iter_i32_8(iter, expr)                     ({ vec_i32_4_t  _buf; vec_loop_stmt( 8, iter, ((vec_alias_int32_t *) &_buf)[iter] = (expr););  _buf; })
#define vec_set_iter_i32_4(iter, expr)                     ({ vec_i32_2_t  _buf; vec_loop_stmt( 4, iter, ((vec_alias_int32_t *) &_buf)[iter] = (expr););  _buf; })
#define vec_set_iter_i32_1(iter, expr)                     (  ( vec_alias_int32_t) vec_iter_expr_1(iter, 0, (expr)) )

#define vec_set_iter_p32_32(iter, expr)                    ({ vec_i32_16_t _buf; vec_loop_stmt(32, iter, ((vec_alias_int32_t *) &_buf)[iter] = (expr););  _buf; })
#define vec_set_iter_p32_16(iter, expr)                    ({ vec_i32_8_t  _buf; vec_loop_stmt(16, iter, ((vec_alias_int32_t *) &_buf)[iter] = (expr););  _buf; })
#define vec_set_iter_p32_8(iter, expr)                     ({ vec_i32_4_t  _buf; vec_loop_stmt( 8, iter, ((vec_alias_int32_t *) &_buf)[iter] = (expr););  _buf; })
#define vec_set_iter_p32_4(iter, expr)                     ({ vec_i32_2_t  _buf; vec_loop_stmt( 4, iter, ((vec_alias_int32_t *) &_buf)[iter] = (expr););  _buf; })
...
#define vec_maskz_loadu_i32_32(ptr, mask)                  ( __riscv_vmerge_vvm_i32m1(__riscv_vmv_v_x_i32m1(0, 32), __riscv_vle32_v_i32m1_m(mask, (vec_alias_int32_t *) (ptr), 32), mask, 32) )
#define vec_maskz_loadu_i32_16(ptr, mask)                  ( __riscv_vmerge_vvm_i32m1(__riscv_vmv_v_x_i32m1(0, 16), __riscv_vle32_v_i32m1_m(mask, (vec_alias_int32_t *) (ptr), 16), mask, 16) )
#define vec_maskz_loadu_i32_8(ptr, mask)                   ( __riscv_vmerge_vvm_i32m1(__riscv_vmv_v_x_i32m1(0,  8), __riscv_vle32_v_i32m1_m(mask, (vec_alias_int32_t *) (ptr),  8), mask,  8) )
#define vec_maskz_loadu_i32_4(ptr, mask)                   ( __riscv_vmerge_vvm_i32m1(__riscv_vmv_v_x_i32m1(0,  4), __riscv_vle32_v_i32m1_m(mask, (vec_alias_int32_t *) (ptr),  4), mask,  4) )
#define vec_maskz_loadu_i32_1(ptr, mask)                   ( (mask) ? (*((vec_alias_int32_t *) (ptr))) : 0 )
...
#define vec_mask_storeu_i32_32(ptr, vec, mask)             __riscv_vse32_v_i32m1_m(mask, (vec_alias_int32_t *) (ptr), vec, 32)
#define vec_mask_storeu_i32_16(ptr, vec, mask)             __riscv_vse32_v_i32m1_m(mask, (vec_alias_int32_t *) (ptr), vec, 16)
#define vec_mask_storeu_i32_8(ptr, vec, mask)              __riscv_vse32_v_i32m1_m(mask, (vec_alias_int32_t *) (ptr), vec,  8)
#define vec_mask_storeu_i32_4(ptr, vec, mask)              __riscv_vse32_v_i32m1_m(mask, (vec_alias_int32_t *) (ptr), vec,  4)
#define vec_mask_storeu_i32_1(ptr, vec, mask)              do { if (mask) (*((vec_alias_int32_t *) (ptr))) = (vec); } while (0)

#define vec_gather_i32_i32_16(ptr, idx)                    __riscv_vluxei32_v_i32m1((vec_alias_int32_t *) (ptr), __riscv_vsll_vx_u32m1(idx, 2, 32), 32)
#define vec_gather_i32_i32_8(ptr, idx)                     __riscv_vluxei32_v_i32m1((vec_alias_int32_t *) (ptr), __riscv_vsll_vx_u32m1(idx, 2, 16), 16)
#define vec_gather_i32_i32_4(ptr, idx)                     __riscv_vluxei32_v_i32m1((vec_alias_int32_t *) (ptr), __riscv_vsll_vx_u32m1(idx, 2,  8),  8)
#define vec_gather_i32_i32_2(ptr, idx)                     __riscv_vluxei32_v_i32m1((vec_alias_int32_t *) (ptr), __riscv_vsll_vx_u32m1(idx, 2,  4),  4)
#define vec_gather_i32_i32_1(ptr, idx)                     ( ((vec_alias_int32_t *) (ptr))[idx] )

#define vec_gather_i32_i64_16(ptr, idx)                    __riscv_vluxei64_v_i32m1((vec_alias_int32_t *) (ptr), __riscv_vlmul_ext_v_i64m1_i64m2(__riscv_vsll_vx_u64m1(idx, 2, 32)), 32)
#define vec_gather_i32_i64_8(ptr, idx)                     __riscv_vluxei64_v_i32m1((vec_alias_int32_t *) (ptr), __riscv_vlmul_ext_v_i64m1_i64m2(__riscv_vsll_vx_u64m1(idx, 2, 16)), 16)
#define vec_gather_i32_i64_4(ptr, idx)                     __riscv_vluxei64_v_i32m1((vec_alias_int32_t *) (ptr), __riscv_vlmul_ext_v_i64m1_i64m2(__riscv_vsll_vx_u64m1(idx, 2,  8)),  8)
#define vec_gather_i32_i64_2(ptr, idx)                     __riscv_vluxei64_v_i32m1((vec_alias_int32_t *) (ptr), __riscv_vlmul_ext_v_i64m1_i64m2(__riscv_vsll_vx_u64m1(idx, 2,  4)),  4)
#define vec_gather_i32_i32_1(ptr, idx)                     ( ((vec_alias_int32_t *) (ptr))[idx] )
...
#define vec_srli_i32_32(a, imm8)                           __riscv_vsrl_vx_u32m1(a, imm8, 32)
#define vec_srli_i32_16(a, imm8)                           __riscv_vsrl_vx_u32m1(a, imm8, 16)
#define vec_srli_i32_8(a, imm8)                            __riscv_vsrl_vx_u32m1(a, imm8,  8)
#define vec_srli_i32_4(a, imm8)                            __riscv_vsrl_vx_u32m1(a, imm8,  4)
...
#define vec_sllv_i32_32(a, count)                          ({ vec_mask_m32_32_t _mask = __riscv_vmsge_vx_i32m1_b32(count, 32, 32); vec_i32_32_t _shifted = __riscv_vsll_vv_i32m1(a, count, 32); __riscv_vmerge_vxm_i32m1(_shifted, 0, _mask, 32); })
#define vec_sllv_i32_16(a, count)                          ({ vec_mask_m32_16_t _mask = __riscv_vmsge_vx_i32m1_b32(count, 32, 16); vec_i32_16_t _shifted = __riscv_vsll_vv_i32m1(a, count, 16); __riscv_vmerge_vxm_i32m1(_shifted, 0, _mask, 16); })
#define vec_sllv_i32_8(a, count)                           ({ vec_mask_m32_8_t  _mask = __riscv_vmsge_vx_i32m1_b32(count, 32,  8); vec_i32_8_t  _shifted = __riscv_vsll_vv_i32m1(a, count,  8); __riscv_vmerge_vxm_i32m1(_shifted, 0, _mask,  8); })
#define vec_sllv_i32_4(a, count)                           ({ vec_mask_m32_4_t  _mask = __riscv_vmsge_vx_i32m1_b32(count, 32,  4); vec_i32_4_t  _shifted = __riscv_vsll_vv_i32m1(a, count,  4); __riscv_vmerge_vxm_i32m1(_shifted, 0, _mask,  4); })
#define vec_sllv_i32_1(a, count)                           ( (int32_t) ((count < 32) ? ((uint32_t) a)<<count : 0) )

#define vec_srlv_i32_32(a, count)                          ({ vec_mask_m32_32_t _mask = __riscv_vmsge_vx_i32m1_b32(count, 32, 32); vec_i32_32_t _shifted = __riscv_vsrl_vv_u32m1(a, count, 32); __riscv_vmerge_vxm_i32m1(_shifted, 0, _mask, 32); })
#define vec_srlv_i32_16(a, count)                          ({ vec_mask_m32_16_t _mask = __riscv_vmsge_vx_i32m1_b32(count, 32, 16); vec_i32_16_t _shifted = __riscv_vsrl_vv_u32m1(a, count, 16); __riscv_vmerge_vxm_i32m1(_shifted, 0, _mask, 16); })
#define vec_srlv_i32_8(a, count)                           ({ vec_mask_m32_8_t  _mask = __riscv_vmsge_vx_i32m1_b32(count, 32,  8); vec_i32_8_t  _shifted = __riscv_vsrl_vv_u32m1(a, count,  8); __riscv_vmerge_vxm_i32m1(_shifted, 0, _mask,  8); })
#define vec_srlv_i32_4(a, count)                           ({ vec_mask_m32_4_t  _mask = __riscv_vmsge_vx_i32m1_b32(count, 32,  4); vec_i32_4_t  _shifted = __riscv_vsrl_vv_u32m1(a, count,  4); __riscv_vmerge_vxm_i32m1(_shifted, 0, _mask,  4); })
...
#define vec_permutexvar_i32_32(a, idx)                     __riscv_vrgather_vv_i32m1(a, idx, 32);
#define vec_permutexvar_i32_16(a, idx)                     __riscv_vrgather_vv_i32m1(a, idx, 16);
#define vec_permutexvar_i32_8(a, idx)                      __riscv_vrgather_vv_i32m1(a, idx,  8);
#define vec_permutexvar_i32_4(a, idx)                      __riscv_vrgather_vv_i32m1(a, idx,  4);
