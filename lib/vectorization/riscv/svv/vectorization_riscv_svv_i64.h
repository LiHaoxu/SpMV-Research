...
#define vec_maskz_loadu_i64_16(ptr, mask)                  ( __riscv_vmerge_vvm_i64m1(__riscv_vmv_v_x_i64m1(0, 16), __riscv_vle64_v_i64m1_m(mask, (vec_alias_int64_t *) (ptr), 16), mask, 16) )
#define vec_maskz_loadu_i64_8(ptr, mask)                   ( __riscv_vmerge_vvm_i64m1(__riscv_vmv_v_x_i64m1(0,  8), __riscv_vle64_v_i64m1_m(mask, (vec_alias_int64_t *) (ptr),  8), mask,  8) )
#define vec_maskz_loadu_i64_4(ptr, mask)                   ( __riscv_vmerge_vvm_i64m1(__riscv_vmv_v_x_i64m1(0,  4), __riscv_vle64_v_i64m1_m(mask, (vec_alias_int64_t *) (ptr),  4), mask,  4) )
#define vec_maskz_loadu_i64_2(ptr, mask)                   ( __riscv_vmerge_vvm_i64m1(__riscv_vmv_v_x_i64m1(0,  2), __riscv_vle64_v_i64m1_m(mask, (vec_alias_int64_t *) (ptr),  2), mask,  2) )
#define vec_maskz_loadu_i64_1(ptr, mask)                   ( (mask) ? (*((vec_alias_int64_t *) (ptr))) : 0 )

#define vec_loadu_firstNz_i64_16(ptr, N)                   ( __riscv_vmerge_vvm_i64m1(__riscv_vmv_v_x_i64m1(0, 16), __riscv_vle64_v_i64m1((vec_alias_int64_t *) (ptr), 16), vec_mask_set_m64_16((1ULL << (N)) - 1), 16) )
#define vec_loadu_firstNz_i64_8(ptr, N)                    ( __riscv_vmerge_vvm_i64m1(__riscv_vmv_v_x_i64m1(0,  8), __riscv_vle64_v_i64m1((vec_alias_int64_t *) (ptr),  8), vec_mask_set_m64_8((1ULL << (N)) - 1),   8) )
#define vec_loadu_firstNz_i64_4(ptr, N)                    ( __riscv_vmerge_vvm_i64m1(__riscv_vmv_v_x_i64m1(0,  4), __riscv_vle64_v_i64m1((vec_alias_int64_t *) (ptr),  4), vec_mask_set_m64_4((1ULL << (N)) - 1),   4) )
#define vec_loadu_firstNz_i64_2(ptr, N)                    ( __riscv_vmerge_vvm_i64m1(__riscv_vmv_v_x_i64m1(0,  2), __riscv_vle64_v_i64m1((vec_alias_int64_t *) (ptr),  2), vec_mask_set_m64_2((1ULL << (N)) - 1),   2) )
...
#define vec_mask_storeu_i64_16(ptr, vec, mask)             __riscv_vse64_v_i64m1_m(mask, (vec_alias_int64_t *) (ptr), vec, 16)
#define vec_mask_storeu_i64_8(ptr, vec, mask)              __riscv_vse64_v_i64m1_m(mask, (vec_alias_int64_t *) (ptr), vec,  8)
#define vec_mask_storeu_i64_4(ptr, vec, mask)              __riscv_vse64_v_i64m1_m(mask, (vec_alias_int64_t *) (ptr), vec,  4)
#define vec_mask_storeu_i64_2(ptr, vec, mask)              __riscv_vse64_v_i64m1_m(mask, (vec_alias_int64_t *) (ptr), vec,  2)
#define vec_mask_storeu_i64_1(ptr, vec, mask)              do { if (mask) (*((vec_alias_int64_t *) (ptr))) = (vec); } while (0)

#define vec_gather_i64_i32_16(ptr, idx)                    __riscv_vluxei32_v_i64m1((vec_alias_int64_t *) (ptr), __riscv_vlmul_trunc_v_i32m1_i32mf2(__riscv_vsll_vx_u32m1(idx, 3, 16)), 16)
#define vec_gather_i64_i32_8(ptr, idx)                     __riscv_vluxei32_v_i64m1((vec_alias_int64_t *) (ptr), __riscv_vlmul_trunc_v_i32m1_i32mf2(__riscv_vsll_vx_u32m1(idx, 3,  8)),  8)
#define vec_gather_i64_i32_4(ptr, idx)                     __riscv_vluxei32_v_i64m1((vec_alias_int64_t *) (ptr), __riscv_vlmul_trunc_v_i32m1_i32mf2(__riscv_vsll_vx_u32m1(idx, 3,  4)),  4)
#define vec_gather_i64_i32_2(ptr, idx)                     __riscv_vluxei32_v_i64m1((vec_alias_int64_t *) (ptr), __riscv_vlmul_trunc_v_i32m1_i32mf2(__riscv_vsll_vx_u32m1(idx, 3,  2)),  2)
#define vec_gather_i64_i32_1(ptr, idx)                     ( ((vec_alias_int64_t *) (ptr))[idx] )

#define vec_gather_i64_i64_16(ptr, idx)                    __riscv_vluxei64_v_i64m1((vec_alias_int64_t *) (ptr), __riscv_vsll_vx_u64m1(idx, 3, 16), 16)
#define vec_gather_i64_i64_8(ptr, idx)                     __riscv_vluxei64_v_i64m1((vec_alias_int64_t *) (ptr), __riscv_vsll_vx_u64m1(idx, 3,  8),  8)
#define vec_gather_i64_i64_4(ptr, idx)                     __riscv_vluxei64_v_i64m1((vec_alias_int64_t *) (ptr), __riscv_vsll_vx_u64m1(idx, 3,  4),  4)
#define vec_gather_i64_i64_2(ptr, idx)                     __riscv_vluxei64_v_i64m1((vec_alias_int64_t *) (ptr), __riscv_vsll_vx_u64m1(idx, 3,  2),  2)
...
#define vec_slli_i64_16(a, imm8)                           __riscv_vsll_vx_i64m1(a, imm8, 16)
#define vec_slli_i64_8(a, imm8)                            __riscv_vsll_vx_i64m1(a, imm8,  8)
#define vec_slli_i64_4(a, imm8)                            __riscv_vsll_vx_i64m1(a, imm8,  4)
#define vec_slli_i64_2(a, imm8)                            __riscv_vsll_vx_i64m1(a, imm8,  2)
#define vec_slli_i64_1(a, imm8)                            ( (int64_t) ((imm8 < 64) ? ((uint64_t) a)<<imm8 : 0) )

#define vec_srli_i64_16(a, imm8)                           __riscv_vsrl_vx_u64m1(a, imm8, 16)
#define vec_srli_i64_8(a, imm8)                            __riscv_vsrl_vx_u64m1(a, imm8,  8)
#define vec_srli_i64_4(a, imm8)                            __riscv_vsrl_vx_u64m1(a, imm8,  4)
#define vec_srli_i64_2(a, imm8)                            __riscv_vsrl_vx_u64m1(a, imm8,  2)
...
#define vec_sllv_i64_16(a, count)                          ({ vec_mask_m64_16_t _mask = __riscv_vmsge_vx_i64m1_b64(count, 64, 16); vec_i64_16_t _shifted = __riscv_vsll_vv_i64m1(a, count, 16); __riscv_vmerge_vxm_i64m1(_shifted, 0, _mask, 16); })
#define vec_sllv_i64_8(a, count)                           ({ vec_mask_m64_8_t  _mask = __riscv_vmsge_vx_i64m1_b64(count, 64,  8); vec_i64_8_t  _shifted = __riscv_vsll_vv_i64m1(a, count,  8); __riscv_vmerge_vxm_i64m1(_shifted, 0, _mask,  8); })
#define vec_sllv_i64_4(a, count)                           ({ vec_mask_m64_4_t  _mask = __riscv_vmsge_vx_i64m1_b64(count, 64,  4); vec_i64_4_t  _shifted = __riscv_vsll_vv_i64m1(a, count,  4); __riscv_vmerge_vxm_i64m1(_shifted, 0, _mask,  4); })
#define vec_sllv_i64_2(a, count)                           ({ vec_mask_m64_2_t  _mask = __riscv_vmsge_vx_i64m1_b64(count, 64,  2); vec_i64_2_t  _shifted = __riscv_vsll_vv_i64m1(a, count,  2); __riscv_vmerge_vxm_i64m1(_shifted, 0, _mask,  2); })
#define vec_sllv_i64_1(a, count)                           ( (int64_t) ((count < 64) ? ((uint64_t) a)<<count : 0) )

#define vec_srlv_i64_16(a, count)                          ({ vec_mask_m64_16_t _mask = __riscv_vmsge_vx_i64m1_b64(count, 64, 16); vec_i64_16_t _shifted = __riscv_vsrl_vv_u64m1(a, count, 16); __riscv_vmerge_vxm_i64m1(_shifted, 0, _mask, 16); })
#define vec_srlv_i64_8(a, count)                           ({ vec_mask_m64_8_t  _mask = __riscv_vmsge_vx_i64m1_b64(count, 64,  8); vec_i64_8_t  _shifted = __riscv_vsrl_vv_u64m1(a, count,  8); __riscv_vmerge_vxm_i64m1(_shifted, 0, _mask,  8); })
#define vec_srlv_i64_4(a, count)                           ({ vec_mask_m64_4_t  _mask = __riscv_vmsge_vx_i64m1_b64(count, 64,  4); vec_i64_4_t  _shifted = __riscv_vsrl_vv_u64m1(a, count,  4); __riscv_vmerge_vxm_i64m1(_shifted, 0, _mask,  4); })
#define vec_srlv_i64_2(a, count)                           ({ vec_mask_m64_2_t  _mask = __riscv_vmsge_vx_i64m1_b64(count, 64,  2); vec_i64_2_t  _shifted = __riscv_vsrl_vv_u64m1(a, count,  2); __riscv_vmerge_vxm_i64m1(_shifted, 0, _mask,  2); })
...
#define vec_permutexvar_i64_16(a, idx)                     __riscv_vrgather_vv_i64m1(a, idx, 16);
#define vec_permutexvar_i64_8(a, idx)                      __riscv_vrgather_vv_i64m1(a, idx,  8);
#define vec_permutexvar_i64_4(a, idx)                      __riscv_vrgather_vv_i64m1(a, idx,  4);
#define vec_permutexvar_i64_2(a, idx)                      __riscv_vrgather_vv_i64m1(a, idx,  2);
