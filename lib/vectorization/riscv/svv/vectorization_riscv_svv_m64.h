...
#define vec_elem_get_m64_16(vec, index)                    ({int64_t _buf[16] = {0}; __riscv_vsm_v_b64((uint8_t *) _buf, vec, 16); _buf[index];})
#define vec_elem_get_m64_8(vec, index)                     ({int64_t _buf[ 8] = {0}; __riscv_vsm_v_b64((uint8_t *) _buf, vec,  8); _buf[index];})
#define vec_elem_get_m64_4(vec, index)                     ({int64_t _buf[ 4] = {0}; __riscv_vsm_v_b64((uint8_t *) _buf, vec,  4); _buf[index];})
#define vec_elem_get_m64_2(vec, index)                     ({int64_t _buf[ 2] = {0}; __riscv_vsm_v_b64((uint8_t *) _buf, vec,  2); _buf[index];})
#define vec_elem_get_m64_1(vec, index)                     vec

#define vec_elem_set_m64_16(vec, index, expr)              do { int64_t _buf[16]; __riscv_vsm_v_b64((uint8_t *) _buf, vec, 16); _buf[index] = (int64_t) (expr); vec = __riscv_vlm_v_b64((const uint8_t *) _buf, 16); } while (0)
#define vec_elem_set_m64_8(vec, index, expr)               do { int64_t _buf[ 8]; __riscv_vsm_v_b64((uint8_t *) _buf, vec,  8); _buf[index] = (int64_t) (expr); vec = __riscv_vlm_v_b64((const uint8_t *) _buf,  8); } while (0)
#define vec_elem_set_m64_4(vec, index, expr)               do { int64_t _buf[ 4]; __riscv_vsm_v_b64((uint8_t *) _buf, vec,  4); _buf[index] = (int64_t) (expr); vec = __riscv_vlm_v_b64((const uint8_t *) _buf,  4); } while (0)
#define vec_elem_set_m64_2(vec, index, expr)               do { int64_t _buf[ 2]; __riscv_vsm_v_b64((uint8_t *) _buf, vec,  2); _buf[index] = (int64_t) (expr); vec = __riscv_vlm_v_b64((const uint8_t *) _buf,  2); } while (0)
#define vec_elem_set_m64_1(vec, index, expr)               do { vec = (expr); } while (0)

#define vec_mask_pack_m64_16(a)                            ({int64_t _buf[16]; __riscv_vsm_v_b64((uint8_t *) _buf, a, 16); _buf[0];})
#define vec_mask_pack_m64_8(a)                             ({int64_t _buf[ 8]; __riscv_vsm_v_b64((uint8_t *) _buf, a,  8); _buf[0];})
#define vec_mask_pack_m64_4(a)                             ({int64_t _buf[ 4]; __riscv_vsm_v_b64((uint8_t *) _buf, a,  4); _buf[0];})
#define vec_mask_pack_m64_2(a)                             ({int64_t _buf[ 2]; __riscv_vsm_v_b64((uint8_t *) _buf, a,  2); _buf[0];})
...
#define vec_mask_set_m64_16(expr)                          ({int64_t _buf[16] = {0}; _buf[0] = (expr); __riscv_vlm_v_b64((const uint8_t *) _buf, 16);})
#define vec_mask_set_m64_8(expr)                           ({int64_t _buf[ 8] = {0}; _buf[0] = (expr); __riscv_vlm_v_b64((const uint8_t *) _buf,  8);})
#define vec_mask_set_m64_4(expr)                           ({int64_t _buf[ 4] = {0}; _buf[0] = (expr); __riscv_vlm_v_b64((const uint8_t *) _buf,  4);})
#define vec_mask_set_m64_2(expr)                           ({int64_t _buf[ 2] = {0}; _buf[0] = (expr); __riscv_vlm_v_b64((const uint8_t *) _buf,  2);})
#define vec_mask_set_m64_1(expr)                           ( (int64_t) (expr) )
