...
#define vec_permutexvar_i64_4(a, idx)                      vec_loop_expr(vec_i64_4_t,   4, _tmp, _i, _tmp.s[_i] = a.s[idx.s[_i]];)
#define vec_permutexvar_i64_2(a, idx)                      vec_loop_expr(vec_i64_2_t,   2, _tmp, _i, _tmp.s[_i] = a.s[idx.s[_i]];)
