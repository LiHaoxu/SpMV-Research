...
#define vec_set_iter_f32_1(iter, expr)                     vec_f32_1( vec_iter_expr_1(iter, 0, (float) (expr)) )
...
#define vec_reduce_add_f32_32(a)                           vec_reduce_expr(float, 4, 0, _tmp, _i, _tmp += vec_reduce_add_f32_8(vec_f32_8(a.v[_i]));)
#define vec_reduce_add_f32_16(a)                           vec_reduce_expr(float, 2, 0, _tmp, _i, _tmp += vec_reduce_add_f32_8(vec_f32_8(a.v[_i]));)
