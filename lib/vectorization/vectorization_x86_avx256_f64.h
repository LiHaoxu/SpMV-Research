...
#define vec_set_iter_f64_1(iter, expr)                     vec_f64_1( vec_iter_expr_1(iter, 0, (double) (expr)) )
...
#define vec_reduce_add_f64_16(a)                           vec_reduce_expr(double, 4, 0, _tmp, _i, _tmp += vec_reduce_add_f64_4(vec_f64_4(a.v[_i]));)
#define vec_reduce_add_f64_8(a)                            vec_reduce_expr(double, 2, 0, _tmp, _i, _tmp += vec_reduce_add_f64_4(vec_f64_4(a.v[_i]));)
