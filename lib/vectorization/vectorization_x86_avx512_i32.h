...
#define vec_set_iter_p32_1(iter, expr)                     vec_perm_p32_1( vec_iter_expr_1(iter, 0, expr) )
...
#define vec_sllv_i32_1(a, count)                           vec_i32_1( ((count.v < 32) ? ((uint32_t) a.v)<<count.v : 0) )
...
#define vec_srlv_i32_1(a, count)                           vec_i32_1( ((count.v < 32) ? ((uint32_t) a.v)>>count.v : 0) )
