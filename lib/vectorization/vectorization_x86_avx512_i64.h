...
#include "vectorization/vectorization_x86_avx512_m64.h"
...
typedef union __attribute__((packed, aligned(8))) { __m128i v;    int64_t s[2];  }  vec_perm_p64_2_t;
typedef union __attribute__((packed, aligned(8))) { __m256i v;    int64_t s[4];  }  vec_perm_p64_4_t;
typedef union __attribute__((packed, aligned(8))) { __m512i v;    int64_t s[8];  }  vec_perm_p64_8_t;
typedef union __attribute__((packed, aligned(8))) { __m512i v[2]; int64_t s[16]; }  vec_perm_p64_16_t;
...
#define vec_set_iter_p64_2(iter, expr)                     vec_perm_p64_2( _mm_set_epi64x(vec_iter_expr_2(iter, 0, expr)) )
#define vec_set_iter_p64_1(iter, expr)                     vec_perm_p64_1( vec_iter_expr_1(iter, 0, expr) )
...
#define vec_sllv_i64_1(a, count)                           vec_i64_1( ((count.v < 64) ? ((uint64_t) a.v)<<count.v : 0) )
...
#define vec_srlv_i64_1(a, count)                           vec_i64_1( ((count.v < 64) ? ((uint64_t) a.v)>>count.v : 0) )
