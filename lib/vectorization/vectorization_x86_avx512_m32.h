...
typedef union __attribute__((packed, aligned(4))) { __mmask8  v;    }  vec_mask_m32_1_t;
typedef union __attribute__((packed, aligned(4))) { __mmask8  v;    }  vec_mask_m32_4_t;
typedef union __attribute__((packed, aligned(4))) { __mmask8  v;    }  vec_mask_m32_8_t;
typedef union __attribute__((packed, aligned(4))) { __mmask16 v;    }  vec_mask_m32_16_t;
typedef union __attribute__((packed, aligned(4))) { __mmask16 v[2]; }  vec_mask_m32_32_t;
...
#define vec_mask_set_m32_1(expr)                           vec_mask_m32_1( vec_iter_expr_1(iter, 0, (expr) & (1 << _j) ? -1 : 0) )
