#ifndef VECTORIZATION_X86_AVX512_F32_H
#define VECTORIZATION_X86_AVX512_F32_H
...
#define vec_maskz_loadu_f32_32(ptr, mask)                  vec_loop_expr(vec_f32_32_t, 2, _tmp, _i, (_tmp).v[_i] = _mm512_maskz_loadu_ps((mask).v[_i], ((__m512 *) (ptr)) + _i);)
#define vec_maskz_loadu_f32_16(ptr, mask)                  vec_f32_16( _mm512_maskz_loadu_ps((mask).v, (__m512 *) (ptr)) )
#define vec_maskz_loadu_f32_8(ptr, mask)                   vec_f32_8( _mm256_maskz_loadu_ps((mask).v, (__m256 *) (ptr)) )
#define vec_maskz_loadu_f32_4(ptr, mask)                   vec_f32_4( _mm_maskz_loadu_ps((mask).v, (__m128 *) (ptr)) )
...
#define vec_mask_storeu_f32_32(ptr, vec, mask)             vec_loop_stmt(4, _i, _mm512_mask_storeu_ps(((__m512 *) (ptr)) + _i, (mask).v[_i], (vec).v[_i]);)
#define vec_mask_storeu_f32_16(ptr, vec, mask)             _mm512_mask_storeu_ps((__m512 *) (ptr), (mask).v, (vec).v)
#define vec_mask_storeu_f32_8(ptr, vec, mask)              _mm256_mask_storeu_ps((__m256 *) (ptr), (mask).v, (vec).v)
#define vec_mask_storeu_f32_4(ptr, vec, mask)              _mm_mask_storeu_ps((__m128 *) (ptr), (mask).v, (vec).v)
...
#define vec_reduce_add_f32_32(a)                           vec_loop_expr_init(float, 2, _tmp, 0, _i, _tmp += vec_reduce_add_f32_16(vec_f32_16((a).v[_i]));)
