...
#define vec_maskz_loadu_f64_16(ptr, mask)                  vec_loop_expr(vec_f64_16_t, 2, _tmp, _i, _tmp.v[_i] = _mm512_maskz_loadu_pd(mask.v[_i], ((__m512d *) (ptr)) + _i);)
#define vec_maskz_loadu_f64_8(ptr, mask)                   vec_f64_8( _mm512_maskz_loadu_pd(mask.v, (__m512d *) (ptr)) )
#define vec_maskz_loadu_f64_4(ptr, mask)                   vec_f64_4( _mm256_maskz_loadu_pd(mask.v, (__m256d *) (ptr)) )
#define vec_maskz_loadu_f64_2(ptr, mask)                   vec_f64_2( _mm_maskz_loadu_pd(mask.v, (__m128d *) (ptr)) )
...
#define vec_mask_storeu_f64_16(ptr, vec, mask)             vec_loop_stmt(2, _i, _mm512_mask_storeu_pd(((__m512d *) (ptr)) + _i, mask.v[_i], vec.v[_i]);)
#define vec_mask_storeu_f64_8(ptr, vec, mask)              _mm512_mask_storeu_pd((__m512d *) (ptr), mask.v, vec.v)
#define vec_mask_storeu_f64_4(ptr, vec, mask)              _mm256_mask_storeu_pd((__m256d *) (ptr), mask.v, vec.v)
#define vec_mask_storeu_f64_2(ptr, vec, mask)              _mm_mask_storeu_pd((__m128d *) (ptr), mask.v, vec.v)
...
#define vec_reduce_add_f64_16(a)                           vec_reduce_expr(double, 2, 0, _tmp, _i, _tmp += vec_reduce_add_f64_8(vec_f64_8(a.v[_i]));)
